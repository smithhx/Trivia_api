...
def create_app(test_config=None):
  ...
  def get_categories():
    ...
    # React code asking for:  Objects are not valid as a React child (found: object with keys {id, type}). 
  ...
  def search_questions():
    ...
    try:
      if search:
        ...
        serached_question = [question.format() for question in questions.all()]

        return jsonify({
          "questions": serached_question,
  ...
  def get_question_by_categories(category_id):
    ...
    try:
      ...
      question_format = [question.format() for question in questions.all()]
      category_format = [question.category for question in questions] 

      return jsonify({
        "success": True,
        "questions": question_format,
        "totalQuestions": len(questions.all()),
        "currentCategory": category_format
      })
    except:
      abort(404)
  ...
  def get_quiz_question():
    ...
    try:
      ...
      options = [question.format() for question in selections 
